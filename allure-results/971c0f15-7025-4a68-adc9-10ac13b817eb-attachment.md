...
Expected value: not "H-Q8WOBW"
Received array:     ["H-Q8WOBW", "H-YBCR8Y", "H-CRK7AH", "H-ZS6RTL", "H-00RREC", "H-FE0HQU", "H-E93NMS", "H-BLV7AK"]
```
      ...
      - generic [ref=e31]:
        - generic [ref=e32]:
          - generic [ref=e33]:
            - generic [ref=e34]:
              - generic [ref=e35]:
                - generic [ref=e36]: H-Q8WOBW
                - generic [ref=e37]: confirmed
                - generic [ref=e38]: "#116881"
        ...
        - generic [ref=e52]:
          - generic [ref=e53]:
            - generic [ref=e54]:
              - generic [ref=e55]:
                - generic [ref=e56]: H-YBCR8Y
                - generic [ref=e57]: confirmed
                - generic [ref=e58]: "#116875"
  ...
  - dialog "Cancel this booking?" [ref=e234]:
    - generic [ref=e235]:
      ...
      - button "Close" [ref=e237] [cursor=pointer]:
        - img [ref=e238]
    - generic [ref=e240]:
      - paragraph [ref=e241]: This will cancel H-Q8WOBW and release 1 seat(s) back to the event. This action cannot be undone.
      - generic [ref=e242]:
...
```ts
  ...
  73 |         }
  74 | 
  75 |         // After cancellation, re-check all refs
  76 |         const remainingRefs = await this.getAllBookingRefs();
> 77 |         await expect(remainingRefs).not.toContain(ref);
     |                                         ^ Error: expect(received).not.toContain(expected) // indexOf
  78 |         Logger.info(`Booking with ref ${ref} successfully cancelled`);
  79 | 
  80 |     }
  81 | }
```