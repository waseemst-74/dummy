...
- main:
  ...
  - text: "H-O54BWV confirmed #116891"
...
- dialog "Cancel this booking?":
  ...
  - button "Close":
    - img
  - paragraph: This will cancel H-O54BWV and release 1 seat(s) back to the event. This action cannot be undone.
  - button "Cancel"
...
> 71 |                 await expect(this.page.locator('[data-testid="toast-success"]')).toBeVisible();
     |                                                                                  ^ Error: expect(locator).toBeVisible() failed
  72 |                 ;
  73 |                 break;
  74 |             }
