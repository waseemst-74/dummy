...
Locator: getByText('Booking Confirmation')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Booking Confirmation')
...
> 32 |         await expect(page.getByText('Booking Confirmation')).toBeVisible({ timeout: 10000 });
     |                                                              ^ Error: expect(locator).toBeVisible() failed
